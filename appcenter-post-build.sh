...
appcenter distribute release -f "build.zip" -r "Build Directory Zipped" -b "1" -a "CSS_Tools/FILES" --token $AppCenterTokenForTest
...
appcenter distribute release -f "tasks.zip" -r "Tasks Directory Zipped" -b "2" -a "CSS_Tools/FILES" --token $AppCenterTokenForTest
